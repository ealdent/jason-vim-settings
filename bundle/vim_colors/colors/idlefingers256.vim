...
hi MatchParen guifg=#FFFFFF ctermfg=15 guibg=#666666 ctermbg=241 
hi ModeMsg gui=NONE 
...
hi StatusLine guifg=#f0e68c ctermfg=222 guibg=#000000 ctermbg=0 
hi StatusLineNC guibg=#f0e68c ctermbg=222 guifg=#666666 ctermfg=241 
...
hi Function guifg=#FFF980 ctermfg=228 gui=NONE 
...
hi Special guifg=#ff6347 ctermfg=203 
    " Underline Character
hi SpecialChar gui=underline guifg=#7fffd4 ctermfg=122 
